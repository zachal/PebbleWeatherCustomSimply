...
static void discon_time_update(Simply *self, SimplyUi *ui){
    ...
    simply_ui_set_text(ui, UiSubtitle, buffer);
...
void simply_msg_show_disconnected(SimplyMsg *self) {
  ...
  simply_ui_set_text(ui, UiSubtitle, "--");
  simply_ui_set_text(ui, UiBody, "-- --");
    discon_time_update(simply,ui);
